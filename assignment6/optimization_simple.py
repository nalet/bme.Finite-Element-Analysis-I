...
def optimization():
    ...
    name_abaqus_job = 'Job-1-clx' #input('Introduce the name of your Job file (e.g., Job-1): ')  # Only in Python 3
    print('Introduce the name of your Job file (e.g., Job-1): ' + name_abaqus_job)
    name_exp_data = 'exp_data_cxl.dat' #input('Introduce the name of your experimental data file (e.g., exp_data_control.dat): ')
